...
import pygobgp.gobgp_pb2 as gobgp__pb2
...
class GobgpApiStub(object):
  ...
  def __init__(self, channel):
    ...
    self.GetPath = channel.unary_stream(
        '/gobgpapi.GobgpApi/GetPath',
        request_serializer=gobgp__pb2.GetPathRequest.SerializeToString,
        response_deserializer=gobgp__pb2.Path.FromString,
        )
...
def add_GobgpApiServicer_to_server(servicer, server):
  rpc_method_handlers = {
      ...
      'GetPath': grpc.unary_stream_rpc_method_handler(
          servicer.GetPath,
